...
import InfoListItem from "@/components/Dashboard/Interactives/InfoListItem";
      ...
      {loadingDetails ? (
        ...
        <div className="lg:border-t-[20px] lg:border-l-[20px] border-t border-gray-300 p-4 h-full overflow-y-auto lg:bg-white bg-gray-300 z-10">
          ...
          <div className="mt-4 z-10">
            ...
            {/* 
        <InfoListItem
          icon={<FaBuilding className="text-2xl text-[#0d7836]" />}
          title="Processing Office"
          value={application?.processingOffice}
        /> */}
          </div>
